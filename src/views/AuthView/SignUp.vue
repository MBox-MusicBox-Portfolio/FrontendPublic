...
<template>
  ...
  <!--<div class="modal" id="modal-edit">
    <div class="modal-dialog  modal-xl">
      <div class="d-flex modal_content">
        <div class="welckom-sign-container">
          <img
          ...
          >
            ...
            <div class="block-sign-button">
              <button class="button-sign">
                <router-link to="/SignIn" class="anim-button-sign"
                  >Sign In</router-link
                >
              </button>
            </div>
        ...
        >
          <div class="mb-4">
            ...
            <div class="block_sign_social mt-3 mb-3">
              <img
                src="../../assets/icons/mbox_facebook.png"
                class="img-sign-facebook"
              />
              <img
                src="../../assets/icons/mbox_google.png"
                class="img-sign-google"
              />
            </div>
            <p class="text-sign-desc">or use email for registration</p>
          </div>
            ...
            >
              ...
              <div class="form-group">
                <img
                  ...
                  class="img-form-control img-form-control-birth"
                />
                <Field
                  name="birthday"
                  type="text"
